...
if param.ctfoverlap==0||isempty(param.defocus), convolved=input; ctf=0; return; end % skip doing CTF
...
q = 0.00; %amplitude contrast value - 7% is generalization
...
for i=1:numel(param.tilt) %loop through tilts
    ...
    for j=1:numel(bincenter)
        ...
        [lg, ctf] = math_ctf(in,cs,L,k,Dzs,B,q,param.phase); %get ctf-convolved subvolume
