...
if strcmp(guiinput,'gui') %basic GUI for manual input of values
    ...
    prompt = {'Microscope voltage (kV)',...
        ...
        'Scan focus (negative for defocus, um)',...
        ...
        'phase shift in radians (~pi/2 for phase plate ideal)',...
        ...
        'Tilt error, 0 no randomization, 1 range =tilt increment'};
...
if param.tilterr~=0 %randomly generate angle errors to add to tiltangles
