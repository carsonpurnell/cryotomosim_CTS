...
%dens1 = 0.94/(1e8)^3/18*6.022e23; %convert from cm3 to a3, then g to molecules via mol/dalton

denspix = (pix^2.8)/24; %^3 theoretical calculation correct, might be as low as 2.7
