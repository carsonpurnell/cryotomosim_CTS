...
input = {'actin__6t1y_13x2.pdb','MT__6o2tx3.pdb','MT__6o2tx2.pdb','ribosome__4ug0.pdb'};%,...
...
%
WriteMRC(vol+solv,outpix,'newsolv1.mrc');
WriteMRC(atlas,outpix,strjoin(['newsolv1_',string(pix),'a_atlas.mrc'],''));
%}
